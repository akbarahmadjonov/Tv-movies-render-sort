...
//     <img src="${
//       el.poster
//     }" width='200' class="card mx-auto d-block mb-3" alt="Card image">
...
// // let newArr = [];
// films.forEach((elOpt) => {
//   let setGenre = new Set(elOpt.genres);

//   let newOpt = document.createElement("option");
//   newOpt.setAttribute("value", elOpt);
//   newOpt.textContent = setGenre;
//   //   console.log(elOpt.genres);

//   elSelect.appendChild(newOpt);
// });
